...
function make_paths(atoms3, indexed_atoms)
    ...
    while true
        ...
        elseif o31 * o32 == -1
            ...
            # a0 = Point2D(getx(a0) + round(first(randn(1)))*eps(Float64), gety(a0) + round(first(randn(1)))*eps(Float64))
            a0 = Point2D(getx(a0) + round(first(randn(1)))*0.001, gety(a0) + round(first(randn(1)))*0.001)
        end
    end
