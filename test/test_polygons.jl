...
test_turn_dict = Dict(map(path2turn, vcat(test_paths...)))
...
@test Set(test_polygons[1][1]) == Set([7, 4, 6, 8, 10, 9])
@test Set(test_polygons[2][1]) == Set([1, 2, 4, 7, 5, 3])
@test Set(test_polygons[3][1]) == Set([5, 7, 9, 10, 11, 12, 13, 12, 14, 12, 11, 10, 8, 6, 4, 2, 1, 3])
